...
QJE grants **few rounds with demanding referees**. Treat an R&R as a near-final opportunity: address everything substantive in this round rather than negotiating across many. The editor's letter is the contract — it tells you which referee points are binding and which are optional. Read it first and let it set priorities.
...
- Promising future work instead of doing the analysis this round (few rounds remain)
...
【Next step】resubmit via Editorial Express (qje-submission for file checks)
```
